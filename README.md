...
- What is the maximum complexity (CCN) per function? 4 is the CCN "since sorting require minimum CCN as 4" and create corresponding yml in the `.github/workflows` folder
